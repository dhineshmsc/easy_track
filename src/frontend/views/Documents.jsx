                    ...
                    <CardContent sx={{ p: 3 }}>
                      ...
                      <List sx={{ p: 0 }}>
                        <ListItem sx={{ px: 0, py: 1, alignItems: 'flex-start' }}>
                          ...
                          <ListItemText
                            primary={<Typography variant="subtitle2" fontWeight={700}>Project Workspace</Typography>}
                            secondary={<Typography variant="body2" color="text.secondary">Isolated environments separated by company domains, allowing clear boundaries between multiple organization accounts.</Typography>}
                          />
                        </ListItem>
                        <ListItem sx={{ px: 0, py: 1, alignItems: 'flex-start' }}>
                          <ListItemIcon sx={{ minWidth: 28, mt: 0.5 }}>
                          ...
                          <ListItemText
                            primary={<Typography variant="subtitle2" fontWeight={700}>User Stories & Hierarchy</Typography>}
                            secondary={<Typography variant="body2" color="text.secondary">Projects serve as root parents. They contain User Stories, which describe standalone feature items. User Stories then group individual sub-tasks and bug reports.</Typography>}
                          />
                        </ListItem>
                        <ListItem sx={{ px: 0, py: 1, alignItems: 'flex-start' }}>
                          <ListItemIcon sx={{ minWidth: 28, mt: 0.5 }}>
                          ...
                          <ListItemText
                            primary={<Typography variant="subtitle2" fontWeight={700}>Kanban Boards & Swimlanes</Typography>}
                            secondary={<Typography variant="body2" color="text.secondary">Provides instant columns for tracking execution states. Drag-and-drop actions automatically fire back-end triggers to update task states.</Typography>}
                          />
                        </ListItem>
                      </List>
                    </CardContent>
